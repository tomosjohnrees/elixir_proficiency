...
describe("stringsInDepth topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(stringsInDepth.quiz.questions).toHaveLength(5);
...
describe("processes topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(processes.quiz.questions).toHaveLength(5);
...
describe("genserver topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(genserver.quiz.questions).toHaveLength(5);
...
describe("supervisors topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(supervisors.quiz.questions).toHaveLength(5);
...
describe("mixAndOtp topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(mixAndOtp.quiz.questions).toHaveLength(5);
...
describe("testing topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(testing.quiz.questions).toHaveLength(5);
...
describe("behaviours topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(behaviours.quiz.questions).toHaveLength(5);
...
describe("macros topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(macros.quiz.questions).toHaveLength(5);
...
describe("errorHandling topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(errorHandling.quiz.questions).toHaveLength(5);
...
describe("comprehensions topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(comprehensions.quiz.questions).toHaveLength(5);
...
describe("sigils topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(sigils.quiz.questions).toHaveLength(5);
...
describe("ectoBasics topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(ectoBasics.quiz.questions).toHaveLength(5);
...
describe("phoenixBasics topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(phoenixBasics.quiz.questions).toHaveLength(5);
...
describe("liveview topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(liveview.quiz.questions).toHaveLength(5);
...
describe("concurrencyPatterns topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(concurrencyPatterns.quiz.questions).toHaveLength(5);
...
describe("deployment topic content", () => {
  ...
  it("has 5 quiz questions", () => {
    expect(deployment.quiz.questions).toHaveLength(5);
